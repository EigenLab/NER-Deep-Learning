...
if __name__ == "__main__":
    DATA_DIR = "/data/xueyou/fashion/data/ner_data_0402"
    checkpoint_dir = '/data/xueyou/ner/clothes_category_ner_lstm_dim256_0402_drop5/'
    ...
    with tf.Session(config=get_config_proto(log_device_placement=False)) as sess:
        ...
        while True:
            ...
            for batch in batch_manager.next_batch():
                ...
                # training data too large, skip eval
